package com.kernotec.driverschedule.user.api.client.rest;
...
import com.kernotec.driverschedule.user.api.config.ModuleAppProperties;
import com.kernotec.driverschedule.user.api.config.ModuleAppProperties.ServiceUri;
